  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >                                                                              X //Falta os parênteses na chamada do método
        ...
        */}
        ...
        <TouchableOpacity
          style={[styles.button, { marginTop: 25 }]}
          onPress={() => this.getCameraPermissions()}                                  X //Falta o "scanner", após o getCameraPermissions
        >
          <Text style={styles.buttonText}>Digitalizar QR Code</Text>
        </TouchableOpacity>
      */}
        ...
        <TouchableOpacity
          style={[styles.button, { marginTop: 25 }]}
          onPress={() => this.getCameraPermissions("scanner")}                         X // Falta o elemento <Text>
        >
        */}
